...
//Description: This class which is named FlightManager is used to manage the flights and airports.
//It is used to search for flights on any day of the week, search for flights on a specific day of the week, 
//finding an airport with a code, find a flight with a code, find flights going between airports on a specified weekday,
//get all of the airports, get all of the flights, populate flights ArrayList with Flight objects from CSV file,
//populate airports with Airport objects from CSV file, and find reservations containing either reservation code or airline.
    ...
    internal class FlightManager
    {
       ...
       */
        ...
        */
        ...
        // This line of code represents the file path to the airports.csv file //Our Comments
        ...
        public static List<Flight> findFlights(string from, string to, string weekday)
        {
            ...
            // This statement iterates through the flight objects of the Flight class to determine if the inputed weekday, departure location //Our Comments
            // and arrival location is available then parses all flight objects with that given input to the list "found" //Our Comments
            foreach (Flight flight in flights)
            {
